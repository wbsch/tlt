...
// Bit values match the game's own button bits (OoTMM combo/controller.h:
// BTN_A=0x8000, BTN_CRIGHT=0x0001, BTN_CLEFT=0x0002, BTN_CUP=0x0008,
// BTN_CDOWN=0x0004 — used via A_BUTTON / R_CBUTTONS / L_CBUTTONS /
// U_CBUTTONS / D_CBUTTONS in kButtonMasks, item_add.c).
...
const SHARED_OCARINA_BUTTON_C_UP_MASK = 0x0008;
const SHARED_OCARINA_BUTTON_C_DOWN_MASK = 0x0004;
