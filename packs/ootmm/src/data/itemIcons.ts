...
const RAW_ITEM_ICONS: Record<string, string> = {
  ...
  // Rusty Keys – OoT
  OOT_RUSTY_KEY_TREASURE_CHEST_GAME: 'images/key_rusty.png',
  OOT_RUSTY_KEY_GUARD_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_HYRULE_CASTLE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_DOG_LADY_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_BACK_ALLEY_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_BOMBCHU_SHOP: 'images/key_rusty.png',
  OOT_RUSTY_KEY_MASK_SHOP: 'images/key_rusty.png',
  OOT_RUSTY_KEY_CHILD_BAZAAR: 'images/key_rusty.png',
  OOT_RUSTY_KEY_CHILD_POTION_SHOP: 'images/key_rusty.png',
  OOT_RUSTY_KEY_CHILD_SHOOTING_GALLERY: 'images/key_rusty.png',
  OOT_RUSTY_KEY_BOMBCHU_BOWLING: 'images/key_rusty.png',
  OOT_RUSTY_KEY_LABORATORY: 'images/key_rusty.png',
  OOT_RUSTY_KEY_FISHING_POND: 'images/key_rusty.png',
  OOT_RUSTY_KEY_SILO: 'images/key_rusty.png',
  OOT_RUSTY_KEY_RANCH_STABLE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_RANCH_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_RANCH_HOUSE_ROOM: 'images/key_rusty.png',
  OOT_RUSTY_KEY_GRAVEYARD: 'images/key_rusty.png',
  OOT_RUSTY_KEY_WINDMILL: 'images/key_rusty.png',
  OOT_RUSTY_KEY_IMPA_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_CARPENTER_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_GRANNY_POTION_SHOP: 'images/key_rusty.png',
  OOT_RUSTY_KEY_ADULT_SHOOTING_GALLERY: 'images/key_rusty.png',
  OOT_RUSTY_KEY_SKULLTULA_HOUSE: 'images/key_rusty.png',
  OOT_RUSTY_KEY_ADULT_BAZAAR: 'images/key_rusty.png',
  OOT_RUSTY_KEY_ADULT_POTION_SHOP: 'images/key_rusty.png',
  OOT_RUSTY_KEY_ADULT_POTION_SHOP_BACK: 'images/key_rusty.png',
  ...
  // Rusty Keys – MM
  MM_RUSTY_KEY_TOURIST_INFORMATION: 'images/key_rusty.png',
  MM_RUSTY_KEY_POTION_SHOP: 'images/key_rusty.png',
  MM_RUSTY_KEY_POST_OFFICE: 'images/key_rusty.png',
  MM_RUSTY_KEY_SWORDSMAN_SCHOOL: 'images/key_rusty.png',
  MM_RUSTY_KEY_LOTTERY: 'images/key_rusty.png',
  MM_RUSTY_KEY_BOMB_SHOP: 'images/key_rusty.png',
  MM_RUSTY_KEY_TRADING_POST: 'images/key_rusty.png',
  MM_RUSTY_KEY_CURIOSITY_SHOP: 'images/key_rusty.png',
  MM_RUSTY_KEY_KAFEI_HIDEOUT: 'images/key_rusty.png',
  MM_RUSTY_KEY_TOWN_ARCHERY: 'images/key_rusty.png',
  MM_RUSTY_KEY_SWAMP_ARCHERY: 'images/key_rusty.png',
  MM_RUSTY_KEY_OBSERVATORY: 'images/key_rusty.png',
  MM_RUSTY_KEY_BLACKSMITH: 'images/key_rusty.png',
  MM_RUSTY_KEY_MUSIC_HOUSE: 'images/key_rusty.png',
  MM_RUSTY_KEY_LABORATORY: 'images/key_rusty.png',
  MM_RUSTY_KEY_BENEATH_GRAVEYARD: 'images/key_rusty.png',
  MM_RUSTY_KEY_DAMPE_HOUSE: 'images/key_rusty.png',
  MM_RUSTY_KEY_MAYOR_RESIDENCE: 'images/key_rusty.png',
  MM_RUSTY_KEY_MAYOR_RESIDENCE_OFFICE: 'images/key_rusty.png',
  MM_RUSTY_KEY_MAYOR_RESIDENCE_SALON: 'images/key_rusty.png',
  MM_RUSTY_KEY_MAYOR_RESIDENCE_KAFEI: 'images/key_rusty.png',
  MM_RUSTY_KEY_TREASURE_CHEST_GAME: 'images/key_rusty.png',
  MM_RUSTY_KEY_HONEY_DARLING: 'images/key_rusty.png',
  MM_RUSTY_KEY_MILK_BAR: 'images/key_rusty.png',
  MM_RUSTY_KEY_DOG_RACETRACK: 'images/key_rusty.png',
  MM_RUSTY_KEY_CUCCO_SHACK: 'images/key_rusty.png',
  MM_RUSTY_KEY_RANCH_HOUSE: 'images/key_rusty.png',
  MM_RUSTY_KEY_RANCH_BARN: 'images/key_rusty.png',
  MM_RUSTY_KEY_RANCH_HOUSE_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_ZORA_SHOP: 'images/key_rusty.png',
  MM_RUSTY_KEY_ZORA_JAPAS_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_ZORA_TIJO_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_ZORA_LULU_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_ZORA_EVAN_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_STOCK_POT_INN: 'images/key_rusty.png',
  MM_RUSTY_KEY_STOCK_POT_INN_ROOF: 'images/key_rusty.png',
  MM_RUSTY_KEY_GRANDMA_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_STOCK_POT_INN_STAFF_ROOM: 'images/key_rusty.png',
  MM_RUSTY_KEY_STOCK_POT_INN_DORMITORY: 'images/key_rusty.png',
  ...
  SHARED_BOOMERANG: 'images/boomerang.png',
  SHARED_SLINGSHOT: 'images/slingshot.png',
  ...
  SHARED_MASK_SKULL: 'images/skull.png',
  SHARED_MASK_SPOOKY: 'images/spooky.png',
  SHARED_MASK_GERUDO: 'images/gerudo.png',
  ...
  SHARED_SONG_AWAKENING: 'images/song_sonata.png',
  ...
  SHARED_SONG_TP_FOREST: 'images/song_forest.png',
  SHARED_SONG_TP_FIRE: 'images/song_fire.png',
  SHARED_SONG_TP_WATER: 'images/song_water.png',
  SHARED_SONG_TP_SPIRIT: 'images/song_spirit.png',
  SHARED_SONG_TP_SHADOW: 'images/song_shadow.png',
  SHARED_SONG_TP_LIGHT: 'images/song_light.png',
  SHARED_SONG_ZELDA: 'images/song_zelda.png',
  SHARED_SONG_ZORA: 'images/song_bossa_nova.png',
  SHARED_SONG_NOTE_AWAKENING: 'images/song_sonata.png',
  SHARED_SONG_NOTE_EMPTINESS: 'images/song_elegy.png',
  SHARED_SONG_NOTE_EPONA: 'images/song_epona.png',
  SHARED_SONG_NOTE_GORON: 'images/song_lullaby.png',
  SHARED_SONG_NOTE_HEALING: 'images/song_healing.png',
  SHARED_SONG_NOTE_ORDER: 'images/song_oath.png',
  SHARED_SONG_NOTE_SARIA: 'images/song_saria.png',
  SHARED_SONG_NOTE_SOARING: 'images/song_soaring.png',
  ...
  SHARED_SONG_NOTE_TP_FOREST: 'images/song_forest.png',
  SHARED_SONG_NOTE_TP_FIRE: 'images/song_fire.png',
  SHARED_SONG_NOTE_TP_WATER: 'images/song_water.png',
  SHARED_SONG_NOTE_TP_SPIRIT: 'images/song_spirit.png',
  SHARED_SONG_NOTE_TP_SHADOW: 'images/song_shadow.png',
  SHARED_SONG_NOTE_TP_LIGHT: 'images/song_light.png',
  SHARED_SONG_NOTE_ZELDA: 'images/song_zelda.png',
  SHARED_SONG_NOTE_ZORA: 'images/song_bossa_nova.png',
...
const GRID_TEXT_LABELS: Record<string, string> = {
  ...
  oot_rusty_market_label: 'Mkt',
  oot_rusty_outside_label: 'Out',
  oot_rusty_ranch_label: 'Ranch',
  oot_rusty_kakariko_label: 'Kak',
  mm_rusty_town_label: 'Town',
  mm_rusty_inn_label: 'Inn',
  mm_rusty_ranch_label: 'Ranch',
  mm_rusty_swamp_label: 'Swamp',
  mm_rusty_mtn_label: 'Mtn',
  mm_rusty_bay_label: 'Bay',
  mm_rusty_ikana_label: 'Ikana',
};
...
const GRID_ICON_BADGE_LABELS: Record<string, string> = {
  ...
  // Rusty Keys – OoT
  OOT_RUSTY_KEY_TREASURE_CHEST_GAME: 'TCG',
  OOT_RUSTY_KEY_GUARD_HOUSE: 'Guard',
  OOT_RUSTY_KEY_HYRULE_CASTLE: 'Castle',
  OOT_RUSTY_KEY_DOG_LADY_HOUSE: 'Dog',
  OOT_RUSTY_KEY_BACK_ALLEY_HOUSE: 'Alley',
  OOT_RUSTY_KEY_BOMBCHU_SHOP: 'Bomb',
  OOT_RUSTY_KEY_MASK_SHOP: 'Mask',
  OOT_RUSTY_KEY_CHILD_BAZAAR: 'Bazar',
  OOT_RUSTY_KEY_CHILD_POTION_SHOP: 'Potion',
  OOT_RUSTY_KEY_CHILD_SHOOTING_GALLERY: 'Shoot',
  OOT_RUSTY_KEY_BOMBCHU_BOWLING: 'Bowl',
  OOT_RUSTY_KEY_LABORATORY: 'Lab',
  OOT_RUSTY_KEY_FISHING_POND: 'Fish',
  OOT_RUSTY_KEY_SILO: 'Silo',
  OOT_RUSTY_KEY_RANCH_STABLE: 'Stable',
  OOT_RUSTY_KEY_RANCH_HOUSE: 'Ranch',
  OOT_RUSTY_KEY_RANCH_HOUSE_ROOM: 'Malon',
  OOT_RUSTY_KEY_GRAVEYARD: 'Grave',
  OOT_RUSTY_KEY_WINDMILL: 'Mill',
  OOT_RUSTY_KEY_IMPA_HOUSE: 'Impa',
  OOT_RUSTY_KEY_CARPENTER_HOUSE: 'Carp',
  OOT_RUSTY_KEY_GRANNY_POTION_SHOP: 'Granny',
  OOT_RUSTY_KEY_ADULT_SHOOTING_GALLERY: 'A.Sht',
  OOT_RUSTY_KEY_SKULLTULA_HOUSE: 'Skull',
  OOT_RUSTY_KEY_ADULT_BAZAAR: 'A.Baz',
  OOT_RUSTY_KEY_ADULT_POTION_SHOP: 'A.Pot',
  OOT_RUSTY_KEY_ADULT_POTION_SHOP_BACK: 'A.P.B',

  // Rusty Keys – MM
  MM_RUSTY_KEY_TOURIST_INFORMATION: 'Info',
  MM_RUSTY_KEY_POTION_SHOP: 'Potion',
  MM_RUSTY_KEY_POST_OFFICE: 'Post',
  MM_RUSTY_KEY_SWORDSMAN_SCHOOL: 'Sword',
  MM_RUSTY_KEY_LOTTERY: 'Lotto',
  MM_RUSTY_KEY_BOMB_SHOP: 'Bomb',
  MM_RUSTY_KEY_TRADING_POST: 'Trade',
  MM_RUSTY_KEY_CURIOSITY_SHOP: 'Curio',
  MM_RUSTY_KEY_KAFEI_HIDEOUT: 'Kafei',
  MM_RUSTY_KEY_TOWN_ARCHERY: 'T.Arch',
  MM_RUSTY_KEY_SWAMP_ARCHERY: 'A.Arch',
  MM_RUSTY_KEY_OBSERVATORY: 'Obsrv',
  MM_RUSTY_KEY_BLACKSMITH: 'Smith',
  MM_RUSTY_KEY_MUSIC_HOUSE: 'Music',
  MM_RUSTY_KEY_LABORATORY: 'Lab',
  MM_RUSTY_KEY_BENEATH_GRAVEYARD: 'Grave',
  MM_RUSTY_KEY_DAMPE_HOUSE: 'Dampe',
  MM_RUSTY_KEY_MAYOR_RESIDENCE: 'Mayor',
  MM_RUSTY_KEY_MAYOR_RESIDENCE_OFFICE: 'Office',
  MM_RUSTY_KEY_MAYOR_RESIDENCE_SALON: 'Salon',
  MM_RUSTY_KEY_MAYOR_RESIDENCE_KAFEI: 'Kafei2',
  MM_RUSTY_KEY_TREASURE_CHEST_GAME: 'TCG',
  MM_RUSTY_KEY_HONEY_DARLING: 'H&D',
  MM_RUSTY_KEY_MILK_BAR: 'Milk',
  MM_RUSTY_KEY_DOG_RACETRACK: 'Dog',
  MM_RUSTY_KEY_CUCCO_SHACK: 'Cucco',
  MM_RUSTY_KEY_RANCH_HOUSE: 'Ranch',
  MM_RUSTY_KEY_RANCH_BARN: 'Barn',
  MM_RUSTY_KEY_RANCH_HOUSE_ROOM: 'Romani',
  MM_RUSTY_KEY_ZORA_SHOP: 'Shop',
  MM_RUSTY_KEY_ZORA_JAPAS_ROOM: 'Japas',
  MM_RUSTY_KEY_ZORA_TIJO_ROOM: 'Tijo',
  MM_RUSTY_KEY_ZORA_LULU_ROOM: 'Lulu',
  MM_RUSTY_KEY_ZORA_EVAN_ROOM: 'Evan',
  MM_RUSTY_KEY_STOCK_POT_INN: 'Inn',
  MM_RUSTY_KEY_STOCK_POT_INN_ROOF: 'Roof',
  MM_RUSTY_KEY_GRANDMA_ROOM: 'Grndma',
  MM_RUSTY_KEY_STOCK_POT_INN_STAFF_ROOM: 'Staff',
  MM_RUSTY_KEY_STOCK_POT_INN_DORMITORY: 'Dorm',
};
