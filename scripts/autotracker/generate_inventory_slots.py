...
SLOT_QUANTITY_RULES = {
    ...
    "ITS_MM_BOW": {"stages": [0x01]},
    "ITS_MM_PICTOBOX": {"stages": [0x0d]},
    "ITS_MM_MASK_STONE": {"stages": [0x45]},
    "ITS_MM_MASK_GIBDO": {"stages": [0x41]},
...
SPECIAL_ITEM_SOURCES = [
    ...
    {"itemId": "OOT_HAMMER", "source": {"kind": "oot-extra-bit", "record": 1, "bit": 21}},
    {"itemId": "OOT_GREAT_FAIRY_SWORD", "source": {"kind": "oot-extra-bit", "record": 1, "bit": 22}},
    ...
    {"itemId": "MM_BOOMERANG", "source": {"kind": "oot-extra-bit", "record": 4, "bit": 24}},
    {"itemId": "MM_PICTOGRAPH_BOX", "source": {"kind": "oot-extra-bit", "record": 4, "bit": 23}},
    {"itemId": "MM_BOW", "source": {"kind": "oot-extra-bit", "record": 4, "bit": 21}},
    {"itemId": "MM_SLINGSHOT", "source": {"kind": "oot-extra-bit", "record": 4, "bit": 22}},
    {"itemId": "MM_MASK_STONE", "source": {"kind": "oot-extra-bit", "record": 4, "bit": 18}},
    ...
    {"itemId": "MM_MASK_GIBDO", "source": {"kind": "oot-extra-bit", "record": 4, "bit": 16}},
